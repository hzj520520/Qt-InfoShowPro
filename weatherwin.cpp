    ...
    ui(new Ui::WeatherWin)
{
    ...
    connect(&manager, &QNetworkAccessManager::finished,
            this, &WeatherWin::read_weather);


    //给指定的控件安装过滤器
    ui->dateLabel->installEventFilter(this);
}
...
void WeatherWin::update_weather(QString address)
{
...
//事件过滤器
bool WeatherWin::eventFilter(QObject *watched, QEvent *event)
{
...
void WeatherWin::read_weather(QNetworkReply *reply)
{
...
void WeatherWin::weather_show(int count)
{
    ui->tempLabel->setText(weathers.at(count).ymd);
