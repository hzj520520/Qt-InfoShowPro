...
struct qt_meta_stringdata_VideoWin_t {
    QByteArrayData data[3];
    char stringdata0[23];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_VideoWin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_VideoWin_t qt_meta_stringdata_VideoWin = {
    {
QT_MOC_LITERAL(0, 0, 8), // "VideoWin"
QT_MOC_LITERAL(1, 9, 12), // "finished_fun"
QT_MOC_LITERAL(2, 22, 0) // ""

    },
    "VideoWin\0finished_fun\0"
};
...
const QMetaObject VideoWin::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_VideoWin.data,
      qt_meta_data_VideoWin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *VideoWin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_VideoWin.stringdata0))
